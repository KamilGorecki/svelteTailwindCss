...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a.textContent = "Home";
    			attr_dev(a, "href", "#/");
    			add_location(a, file, 3, 8, 28);
    			add_location(header, file, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "Ka-Mil IT";
    			add_location(h1, file$1, 5, 2, 33);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$3, 15, 0, 279);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Header, Home, NotFound, routes });
    	return [routes];
    }
